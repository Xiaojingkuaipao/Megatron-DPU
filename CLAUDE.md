...
When working with code under `sglang/python/sglang/srt/speculative/` or related attention backends, follow these rules (see `.claude/rules/speculative-naming.md` for full details):
